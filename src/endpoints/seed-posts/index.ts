...
const POSTS = ({ imageId, authorId }: PostDeps): RequiredDataFromCollectionSlug<'posts'>[] => [
  {
    ...
    meta: {
      title: 'Полный гид по покупке первой квартиры — Realty',
      description:
  ...
  },
  {
    ...
    meta: {
      title: 'Как выбрать риелтора — Realty',
  ...
  },
  {
    ...
    meta: {
      title: 'Инвестиции в недвижимость для начинающих — Realty',
